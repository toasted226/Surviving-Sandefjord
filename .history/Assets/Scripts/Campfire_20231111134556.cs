...
public class Campfire : Interactable
{
    ...
    [SerializeField]private float warningHeatRange;
    [SerializeField]private float heatPerLog;
    [SerializeField]private float heatRange;

    [SerializeField]private Transform heatIndicator;

    void Start()
    {
        heatRemaining = maxHeat / 3;
        heatIndicator.localScale = new Vector3(heatRange * 2, heatRange * 2, 1f);
    }
